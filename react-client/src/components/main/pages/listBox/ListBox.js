        ...
        return (
            <div className="list-box background-outer col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div className="row p-2 align-self-center">
                    ...
                    <div className="d-flex align-items-center list-box box-height col-3 col-sm-2 col-md-3 col-lg-4 col-xl-3" style={{background: 'rgb(' + this.state.RGBColor[0] + ', ' + this.state.RGBColor[1] + ', ' + this.state.RGBColor[2] + ')'}}>
                        <span className="icon" data-icon={this.state.setWeatherIcon}></span>
                    </div>
                    <div className="d-flex align-items-center list-box box-height col-7 col-sm-5 col-md-7 col-lg-6 col-xl-7" style={{background: 'rgb(' + this.state.RGBColor[0] + ', ' + this.state.RGBColor[1] + ', ' + this.state.RGBColor[2] + ')'}}>
                        <div className="row">
                    ...
                    <div className="d-flex justify-content-end list-box box-height col-2 col-sm-1 col-md-2 col-lg-2 col-xl-2 p-0" style={{background: 'rgb(' + this.state.RGBColor[0] + ', ' + this.state.RGBColor[1] + ', ' + this.state.RGBColor[2] + ')'}}>
